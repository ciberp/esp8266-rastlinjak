    ...
    String webMetaRefreshsetcorrect="<meta http-equiv=\"refresh\" content=\"0;url=/setcorrect\">";
    String webMetaRefreshsetsens="<meta http-equiv=\"refresh\" content=\"0;url=/setsens\">";
    String webMetaRefreshsetwifi="<meta http-equiv=\"refresh\" content=\"0;url=/setwifi\">";
    ...
    // 15 = D8 * SERVO
    // 16 = D0 *
    int pin_namakanje_rastlinjak = 15;      //D8
    ...
    void setup(void)
    {
      ...
      server.on("/setwifi",handle_Settings_WiFi);
      server.on("/setsens",handle_Settings_Ostalo);
      server.on("/stimei",handle_stime_inc);
      server.on("/stimed",handle_stime_dec);
      server.on("/setcorrect",handle_Settings_Korekcije);
...
//      server.on("/zrachip",handle_zracenje_histereza_inc);  
      ...
      server.on("/save", []() {
        ...
        webString=webMetaRefreshsetwifi;
...
//      }
    ...
    void handle_load_defaults() {
      ...
      SETTINGS.namakanje_rastlinjak_value = 23;
      SETTINGS.namakanje_rastlinjak_open_time = 5;
      SETTINGS.namakanje_rastlinjak_hist = 5;
    ...
    void handle_root() {
        webString="<HTML><meta charset=\"UTF-8\">\n"
        //"<title>   { Rastlinjak }   </title>\n"
        "<style>.g{width:100%;height:150px;font-size:150%;color:blue;font-weight: bold;}.s{font-size:300%;color:blue;font-weight: bold;border-color: blue; background: #f2f2f2;}"
        ".t{width:100%;height:10%;font-size:250%;color:blue;font-weight: bold;}table{border-collapse:collapse;width: 100%;}th,td{text-align:left;}"
        "tr:nth-child(even){background-color: #f2f2f2}th{background-color:blue;color:white;}.nowrap {white-space:nowrap}</style>"
        ...
        "</head><body>"
        "<div id=\"div\">Checking ...</div>"
        "<table class=\"t\">"
//        "<tr><td>OKNA:</td><td><a href=\"/winclosestep\"><button class=\"g\">-</button></a></td><td>" + String((int)myServo) + "</td><td><a href=\"/winopenstep\"><button class=\"g\">+</button></a></td>"
//        "<td><a href=\"/winclosefull\"><button class=\"g\">ZAPRI</button></a></td>"
//        "<td><a href=\"/winopenfull\"><button class=\"g\">ODPRI</button></a></td></tr>\n"
        "<tr><td>NAMAKANJE RASTL.:</td><td></td><td>" + String((boolean)digitalRead(pin_namakanje_rastlinjak)) + "</td><td></td>"
        "<td><a href=\"/waterrastoff\"><button class=\"g\">OFF</button></a></td>"
        "<td><a href=\"/waterraston\"><button class=\"g\">ON</button></a></td></tr>\n"
        "<tr><td>NAMAKANJE ZUNAJ:</td><td></td><td>" + String((boolean)digitalRead(pin_namakanje_zunaj)) + "</td><td></td>"
        "<td><a href=\"/waterzuoff\"><button class=\"g\">OFF</button></a></td>"
        "<td><a href=\"/waterzuon\"><button class=\"g\">ON</button></a></td></tr>\n"
        "<tr><td>BEEPER:</td><td></td><td>" + String((boolean)digitalRead(pin_beeper)) + "</td><td></td>"
        "<td><a href=\"/beeperoff\"><button class=\"g\">OFF</button></a></td>"
        "<td><a href=\"/beeperon\"><button class=\"g\">ON</button></a></td></tr>\n"
        "<tr><td>STIKALO:</td><td></td><td>" + String((boolean)digitalRead(pin_led)) + "</td><td></td>"
        "<td><a href=\"/ledoff\"><button class=\"g\">OFF</button></a></td>"
        "<td><a href=\"/ledon\"><button class=\"g\">ON</button></a></td></tr>"
        "</table><br>"
        "<a href=\"/setsens\"><button class=\"g\" style=\"width:100%\"><h1>NASTAVITVE SENZORJI</h1></button></a>\n"
        "<a href=\"/setwifi\"><button class=\"g\" style=\"width:100%\"><h1>NASTAVITVE WIFI</h1></button></a>\n"
        "<a href=\"/setcorrect\"><button class=\"g\" style=\"width:100%\"><h1>NASTAVITVE KOREKCIJ</h1></button></a>\n"
        "</BODY></HTML>\n";
        server.send(200, "text/html", webString);
    }
    ...
    void handle_values() {
        ...
        "<tr><td>" + String((float)soil_hum) + "% [" + String((int)SETTINGS.namakanje_rastlinjak_value) + "]</td><td>" + String((float)soil_ph) + "</td><td>" + String((float)soil_light) + "</td></tr>\n"
        "<tr><td colspan=\"3\">&nbsp;</td></tr>"
        "<tr><th>VLAGA ZEMLJE (VRT)</th><th>pH ZEMLJE (VRT)</th><th>SEVANJE (VRT)</th></tr>\n"
        "<tr><td>" + String((float)zunaj_soil_hum) + "% [" + String((int)SETTINGS.namakanje_zunaj_value) + "]</td><td>" + String((float)zunaj_soil_ph) + "</td><td>" + String((float)zunaj_light) + "</td></tr>\n"
        "<tr><td colspan=\"3\">&nbsp;</td></tr>"
    ...
    void handle_Settings_WiFi() {   
        ...
        "<table><tr><td>Deep sleep time:</td><td><a href=\"/stimed\"><button class=\"g\"><h1>-</h1></button></a>" + String((int)SETTINGS.sleep_time) + "min<a href=\"/stimei\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td><form method='get' action='save'>SSID:</td><td><input name='ssid' value='" + String(SETTINGS.ssid) + "' maxlength='32' type='text'></td></tr>"
    ...
    void handle_Settings_Ostalo() {   
        webString="<!DOCTYPE html><HTML><meta charset=\"UTF-8\">\n"
        "<style>table,td{font-size:160%;text-align:center;}\n"
        "<style scoped>.g{width:100px;height:100%}h1{font-size:400%;color:blue;}</style>"
        "<table>"
        "<tr><th colspan=\"4\">NASTAVITVE ZRAČENJA</th></tr>\n"
        "<tr><td>zračenje nad:</td><td><a href=\"/zracm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.zracenje_temp_value) + "°C</td><td><a href=\"/zracp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>histereza</td><td><a href=\"/zrachim\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.zracenje_temp_hist) + "°C</td><td><a href=\"/zrachip\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>čas ročnega zrač.:</td><td><a href=\"/zractm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.zracenje_open_time) + "min</td><td><a href=\"/zractp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>čs avto. zrač.:</td><td><a href=\"/zracatm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.zracenje_auto_open_time) + "min</td><td><a href=\"/zracatp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>avto. zračenje:</td><td colspan=\"2\">"+ String((boolean)SETTINGS.zracenje_state) + "</td><td><a href=\"/zracam\"><button  style=\"width:100%;height:100%\"><h1>ON/OFF</h1></button></a></td></tr>\n"
        "<tr><th colspan=\"4\">NASTAVITVE NAMAKANJA - RASTLINJAK</th></tr>"
        "<tr><td>namakanje pod:</td><td><a href=\"/namm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_rastlinjak_value) + "%</td><td><a href=\"/namp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>histereza:</td><td><a href=\"/namhim\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_rastlinjak_hist) + "%</td><td><a href=\"/namhip\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>čas ročnega nam.:</td><td><a href=\"/namtm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_rastlinjak_open_time) + "min</td><td><a href=\"/namtp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>čas avto. nam.:</td><td><a href=\"/namatm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_rastlinjak_auto_open_time) + "min</td><td><a href=\"/namatp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>avto. namakanje:</td><td colspan=\"2\">"+ String((boolean)SETTINGS.namakanje_rastlinjak_state) + "</td><td><a href=\"/zracam\"><button  style=\"width:100%;height:100%\"><h1>ON/OFF</h1></button></a></td></tr>\n"
        "<tr><th colspan=\"4\">NASTAVITVE NAMAKANJA - VRT</th></tr>";
        server.sendContent(webString); // poslje paket
        webString = "<tr><td>namakanje pod:</td><td><a href=\"/namzm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_zunaj_value) + "%</td><td><a href=\"/namzp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>histereza:</td><td><a href=\"/namzhim\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_zunaj_hist) + "%</td><td><a href=\"/namzhip\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>čas ročnega nam.:</td><td><a href=\"/namztm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_zunaj_open_time) + "min</td><td><a href=\"/namztp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>čas avto. nam.:</td><td><a href=\"/namzatm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.namakanje_zunaj_auto_open_time) + "min</td><td><a href=\"/namzatp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>avto. namakanje:</td><td colspan=\"2\">"+ String((boolean)SETTINGS.namakanje_zunaj_state) + "</td><td><a href=\"/zracam\"><button  style=\"width:100%;height:100%\"><h1>ON/OFF</h1></button></a></td></tr>\n"
        "<tr><th colspan=\"4\">NASTAVITVE TEMP. SENZORJEV</th></tr>"
        "<tr><td>id zunaj:</td><td><a href=\"/tszum\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.ID_ds_temp_zunaj) +"</td><td><a href=\"/tszup\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>id znotraj:</td><td><a href=\"/tsznm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.ID_ds_temp_znotraj) +"</td><td><a href=\"/tsznp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>id tla:</td><td><a href=\"/tstlm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.ID_ds_temp_tla) +"</td><td><a href=\"/tstlp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "</table>"
        "</BODY></HTML>\n";
        server.send(200, "text/html", webString);
    }

    void handle_Settings_Korekcije() {   
        webString="<!DOCTYPE html><HTML><meta charset=\"UTF-8\">\n"
        ...
        "<table><tr><th colspan=\"4\">NASTAVITVE KOREKCIJ</th></tr>"
        "<tr><td>light_k:</td><td><a href=\"/light_km\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.soil_light_k) +"</td><td><a href=\"/light_kp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>light_n:</td><td><a href=\"/light_nm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.soil_light_n) +"</td><td><a href=\"/light_np\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>pH_k:</td><td><a href=\"/ph_km\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.soil_ph_k) +"</td><td><a href=\"/ph_kp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>pH_n:</td><td><a href=\"/ph_nm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.soil_ph_n) +"</td><td><a href=\"/ph_np\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>hum_k:</td><td><a href=\"/hum_km\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.soil_hum_k) +"</td><td><a href=\"/hum_kp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>hum_n:</td><td><a href=\"/hum_nm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.soil_hum_n) +"</td><td><a href=\"/hum_np\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>voltage_k:</td><td><a href=\"/voltage_km\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.voltage_k) +"</td><td><a href=\"/voltage_kp\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "<tr><td>voltage_n:</td><td><a href=\"/voltage_nm\"><button class=\"g\"><h1>-</h1></button></a></td><td>" + String((int)SETTINGS.voltage_n) +"</td><td><a href=\"/voltage_np\"><button class=\"g\"><h1>+</h1></button></a></td></tr>\n"
        "</table>"
        "<style scoped>.g{width:100%;height:300px}h1{font-size:400%;color:blue;}</style>"
        "<a href=\"/\"><button class=\"g\"><h1>NAZAJ</h1></button></a>"
        "</BODY></HTML>\n";
    ...
    void handle_namakanje_rastlinjak_auto_open_time_dec() {
      ...
      webString=webMetaRefreshsetsens;
      server.send(200, "text/html", webString);
    }
    ...
    void NamakanjeRastlinjakFunc() {      
      if (SETTINGS.namakanje_rastlinjak_state and not namakanje_rastlinjak_timer) { // state = true = AUTO
        if (soil_hum + SETTINGS.namakanje_rastlinjak_hist < SETTINGS.namakanje_rastlinjak_value and not namakanje_rastlinjak_auto_timer) {
          digitalWrite(pin_namakanje_rastlinjak, HIGH);
        }
        if (soil_hum - SETTINGS.namakanje_rastlinjak_hist > SETTINGS.namakanje_rastlinjak_value and not namakanje_rastlinjak_auto_timer) {
          digitalWrite(pin_namakanje_rastlinjak, LOW);
      ...
      if (namakanje_rastlinjak_auto_timer) {
        if (millis() > namakanje_rastlinjak_auto_previous_millis + SETTINGS.namakanje_rastlinjak_auto_open_time * 1000 * 60) {
          namakanje_rastlinjak_auto_timer = false;
    ...
    void NamakanjeZunajFunc() {
      if (SETTINGS.namakanje_zunaj_state and not namakanje_zunaj_timer) { // state = true = AUTO
        if (zunaj_soil_hum + SETTINGS.namakanje_zunaj_hist < SETTINGS.namakanje_zunaj_value and not namakanje_zunaj_auto_timer) {
          digitalWrite(pin_namakanje_zunaj, HIGH);
...
//    }
    ...
    void handle_json() {
      ...
      "\", \"Switch2\": \"" + String((boolean)digitalRead(pin_led)) + 
    ...
    void handle_light_km() {
      ...
      webString=webMetaRefreshsetcorrect;
      server.send(200, "text/html", webString);
    }
...
//    
    void ReadADC() {
      ...
      //Average_readIndex ++;
      napajanje = analogRead(A0) / SETTINGS.voltage_k + SETTINGS.voltage_n;
      // A3 = Bat (12V)
      ...
      //Average_readIndex ++;
      napetost_baterije = analogRead(A0) / SETTINGS.voltage_k + SETTINGS.voltage_n;
      ...
      //Average_readIndex ++;
      // y = kx + n
      soil_hum = analogRead(A0) / SETTINGS.soil_hum_k + SETTINGS.soil_hum_n;
      ...
      //Average_readIndex ++;
      soil_ph = SETTINGS.soil_ph_k / (analogRead(A0) + SETTINGS.soil_ph_n);
      // A4 = Rastlinjak Light
      digitalWrite(pin_select_s0, LOW);
      digitalWrite(pin_select_s1, LOW);
      ...
      //Average_readIndex ++;
      soil_light = analogRead(A0) * 10 / SETTINGS.soil_light_k + SETTINGS.soil_light_n;
      ...
      //Average_readIndex ++;
      zunaj_soil_hum = analogRead(A0) / SETTINGS.soil_hum_k + SETTINGS.soil_hum_n;
      // A5 = Zunaj Soil pH
      digitalWrite(pin_select_s0, HIGH);
      digitalWrite(pin_select_s1, LOW);
      digitalWrite(pin_select_s2, HIGH);
      ...
      zunaj_soil_ph = SETTINGS.soil_ph_k / (analogRead(A0) + SETTINGS.soil_ph_n);
      // A6 = Zunaj Light
      digitalWrite(pin_select_s0, LOW);
      digitalWrite(pin_select_s1, HIGH);
      digitalWrite(pin_select_s2, HIGH);
      ...
      //Average_readIndex ++;
      zunaj_light = analogRead(A0) * 10 / SETTINGS.soil_light_k + SETTINGS.soil_light_n;
...
//      }
    ...
    void handle_Sleep() {
      ...
      Serial.print(SETTINGS.sleep_time);
      Serial.println("min");
      webString="<HTML><meta charset=\"UTF-8\">\n"
        "</head><body>"
        "<div id=\"div\">Going to sleep for: "+ String((int)SETTINGS.sleep_time) + "</div>"
         "</body></html>\n";;
      server.send(200, "text/html", webString);
      ESP.deepSleep(SETTINGS.sleep_time * 1000000 * 60);  
    }

        void handle_stime_inc() {
      if (SETTINGS.sleep_time < 360) {
        SETTINGS.sleep_time++;
      }
      webString=webMetaRefreshsetwifi;
      server.send(200, "text/html", webString);
    ...
    void handle_stime_dec() {
      if (SETTINGS.sleep_time > 1) {
        SETTINGS.sleep_time--;
      }
      webString=webMetaRefreshsetwifi;
      server.send(200, "text/html", webString);
